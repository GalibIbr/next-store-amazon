...
import { addToCard, addToFavorite } from "@/store/nextSlice";
    ...
    md:py-10">
      <div className="w-full grid md:grid-cols-3 gap-3 bg-gray-100 rounded-lg">
        ...
        <div className="md:col-span-2 flex flex-col gap-3 justify-center p-4">
          <p
            className="txtxs
           md:text-sm text-amazon_blue font-semibold -mb-3">
          ...
          <div>
            <p className="text-base text-gray-600 flex items-center gap-1">
              ...
              <span className="text-lg text-amazon_blue font-semibold">
                <FormattedPrice amoat={product.price} />
              </span>
              <span className="ml-1 line-through">
                <FormattedPrice amoat={product.oldPrice} />
              </span>
            </p>
            <p className="text-sm text-gray-500 flex items-center gap-1">
              Your saved:{" "}
              <span>
                <FormattedPrice amoat={product.oldPrice - product.price} />
              </span>
            </p>
            <button
              onClick={() =>
